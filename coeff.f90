module coeff
!--------------------------------------------------------------------------------------------------------------
  ! This module defines the function "element" which computes the coefficients of the L2 projection
  ! of a given function onto the space of Legendre polynomials for a given interval
!--------------------------------------------------------------------------------------------------------------
  use type_defs
  use InputControl
  use lgl
